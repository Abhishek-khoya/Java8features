...
public class EmployeeDataBase {
    public static List<Employee> getAllEmployees()
    {
        ...
        Project p3=new Project("P003","Gamma","PQR Corp","Mark");
        ...
        Project p10=new Project("P0010","Kappa","DigitalWave","Jessica");
        ...
        Employee e5=new Employee(5,"Michale Green","Finance",Arrays.asList(p5),90000,"Male");
